...
# Incremental RUN 
if spark.catalog.tableExists('cars_catalog.gold.dim_date'):
    delta_table = DeltaTable.forPath(spark, "abfss://gold@p1datalake.dfs.core.windows.net/dim_date")
...
# Initial RUN 
    ...
    df_final.write.format("delta")\
        .mode("overwrite")\
        .option("path", "abfss://gold@p1datalake.dfs.core.windows.net/dim_date")\
