...
df_silver =spark.sql("SELECT * from PARQUET.`abfss://silver@p1datalake.dfs.core.windows.net/carsales`") 
...
if spark.catalog.tableExists('factsales'): 
    ...
    df_fact.write.format('delta')\
            .mode('Overwrite')\
            .option("path", "abfss://gold@p1datalake.dfs.core.windows.net/factsales")\
